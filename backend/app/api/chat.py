...
async def chat_endpoint(
    ...
    try:
        ...
        # CRITICAL FIX: PRODUCT CONTEXT PERSISTENCE 
        ...
        # STEP 2: CRITICAL FIX - If no new selection, use existing context for follow-up questions
            ...
            if existing_selected_id and existing_context_product:
                ...
                logger.info(f"Using existing selected product context: {selected_product.get('title', 'Unknown')}")
