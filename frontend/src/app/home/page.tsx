...
export default function FullChatPage() {
  ...
  <RequireEmail>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Fixed Header */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900/80 backdrop-blur border-b border-gray-200 dark:border-gray-800 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-lg font-semibold text-gray-800 dark:text-gray-100">AI Shopping Assistant</h1>
            </div>
          </div>
          ...
          {messages.length <= 1 && (
            <div className="text-center py-12">
              <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-8 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">Welcome to AI Shopping Assistant!</h2>
